...
class Enroll:
    ...
    def __init__(self,window, ucinetid = None, password = None, courses = []):
        self.window = window
        self.running = False
        ...
        label2 = tkinter.Label(self.window, text = 'produce by yc\nOutput:', font = ('Helvetica', 15))
